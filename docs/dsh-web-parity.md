...
| Approval composer (`approval-composer.e2e.ts`, `access-confirmation.e2e.ts`)                                                                  | **Not mounted**     | Destructive file confirmation is a local Alert                                                                                                       | No DSH approval request protocol, scope choice, allow/deny response, persistence, or tool resumption.                                 |
| Structured questions (`question-composer.e2e.ts`)                                                                                             | **Not mounted**     | None                                                                                                                                                 | Add DSH question events, mobile option/free-text composer, validation, submit/cancel, and replay.                                     |
